...
POLICIES = {
    ...
    'qwen397_native_p_reuse': {
        ...
        'FLASHQLA_BLACKWELL_BLOCK_DV': '64',
        'FLASHQLA_BLACKWELL_FWD_THREADS': '256',
        'FLASHQLA_BLACKWELL_FWD_SYNC_BARRIERS': 'load,h,o,ag',
        'FLASHQLA_BLACKWELL_PRECOMPUTE_P': '1',
    },
    'qwen397_native_p_precompute_only': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE_KERNELS': 'fwd,kkt',
        'FLASHQLA_BLACKWELL_FWD_POLICY': 'native',
        ...
        'FLASHQLA_BLACKWELL_FWD_SYNC_BARRIERS': 'load,h,o,ag',
        'FLASHQLA_BLACKWELL_PRECOMPUTE_P': '1',
        'FLASHQLA_BLACKWELL_USE_PRECOMPUTED_P': '0',
    },
    'qwen397_native_p_reuse_keep_gemm': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE_KERNELS': 'fwd,kkt',
        'FLASHQLA_BLACKWELL_FWD_POLICY': 'native',
        ...
        'FLASHQLA_BLACKWELL_FWD_SYNC_BARRIERS': 'load,h,o,ag',
        'FLASHQLA_BLACKWELL_PRECOMPUTE_P': '1',
        'FLASHQLA_BLACKWELL_PRECOMPUTED_P_KEEP_GEMM': '1',
    },
    'qwen397_native_b32': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
    ...
    'qwen397_native_auto_dv_b32': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE_KERNELS': 'fwd,kkt',
        'FLASHQLA_BLACKWELL_FWD_POLICY': 'native',
        'FLASHQLA_BLACKWELL_MIN_BLOCK_DV': '32',
        'FLASHQLA_BLACKWELL_TMEM_WIDTH': 'exact',
        'FLASHQLA_BLACKWELL_FWD_THREADS': '256',
        'FLASHQLA_BLACKWELL_FWD_SYNC_BARRIERS': 'load,h,o',
    },
    'qwen397_native_varlen_exp': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE_VARLEN': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE_KERNELS': 'fwd,kkt',
        'FLASHQLA_BLACKWELL_FWD_POLICY': 'native',
        'FLASHQLA_BLACKWELL_BLOCK_DV': '64',
    ...
    'qwen397_native_pipeline': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE_KERNELS': 'fwd,kkt',
        'FLASHQLA_BLACKWELL_FWD_POLICY': 'native',
        'FLASHQLA_BLACKWELL_FWD_EXPERIMENT': 'pipeline',
        'FLASHQLA_BLACKWELL_PRETRANSFORM_A': '0',
        'FLASHQLA_BLACKWELL_BLOCK_DV': '64',
    },
    'qwen397_native_seg4': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        ...
        'FLASHQLA_BLACKWELL_SEGMENT_CHUNKS': '4',
    },
    'qwen397_native_seg8': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
    ...
    'qwen397_native_seg16': {
        ...
        'FLASHQLA_BLACKWELL_FWD_THREADS': '256',
        'FLASHQLA_BLACKWELL_FWD_SYNC_BARRIERS': 'load,h',
        'FLASHQLA_BLACKWELL_SEGMENT_CHUNKS': '16',
    },
    'qwen397_native_512': {
        'FLASHQLA_ENABLE_BLACKWELL_FWD_NATIVE': '1',
        'FLASHQLA_BLACKWELL_NATIVE': '1',
...
ENV_TO_CLEAR = (
    ...
    "FLASHQLA_BLACKWELL_USE_PRECOMPUTED_P",
    "FLASHQLA_BLACKWELL_PRECOMPUTED_P_KEEP_GEMM",
